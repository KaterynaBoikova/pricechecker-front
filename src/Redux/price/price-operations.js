...
const fetchPricesZamokUkr = (jobId) => async (dispatch) => {
  ...
  await axios
    .get(`/jobs/Result/${jobId}`)
    .then(({ data }) => dispatch(actions.fetchPricesZamokUkrSuccess(data)))
    .catch((error) =>
      dispatch(actions.fetchPricesZamokUkrError(error.message))
    );
};
const fetchPricesTopZamok = (jobId) => async (dispatch) => {
  ...
  await axios
    ...
    .catch((error) =>
      dispatch(actions.fetchPricesTopZamokError(error.message))
    );
};
//fetch all per click
...
const fetchPricesKupiZamok = () => async (dispatch) => {
  ...
  await axios
    ...
    .catch((error) =>
      dispatch(actions.fetchPricesKupiZamokError(error.message))
    );
};
...
const fetchPricesSvitZamkiv = () => async (dispatch) => {
  ...
  await axios
    ...
    .catch((error) =>
      dispatch(actions.fetchPricesSvitZamkivError(error.message))
    );
};
const fetchPricesZamochniki = () => async (dispatch) => {
  ...
  await axios
    ...
    .catch((error) =>
      dispatch(actions.fetchPricesZamochnikiError(error.message))
    );
};
