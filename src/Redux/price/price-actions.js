...
const fetchPricesKreminRequest = createAction(
  "prices/fetchPricesKreminRequest"
);
const fetchPricesKreminSuccess = createAction(
  "prices/fetchPricesKreminSuccess"
);
...
const fetchPricesZamokUkrRequest = createAction(
  "prices/fetchPricesZamokUkrRequest"
);
const fetchPricesZamokUkrSuccess = createAction(
  "prices/fetchPricesZamokUkrSuccess"
);
const fetchPricesZamokUkrError = createAction(
  "prices/fetchPricesZamokUkrError"
);
const hideErrorZamokUkr = createAction("prices/hideErrorZamokUkr");

const fetchPricesTopZamokRequest = createAction(
  "prices/fetchPricesTopZamokRequest"
);
const fetchPricesTopZamokSuccess = createAction(
  "prices/fetchPricesTopZamokSuccess"
);
const fetchPricesTopZamokError = createAction(
  "prices/fetchPricesTopZamokError"
);
const hideErrorTopZamok = createAction("prices/hideErrorTopZamok");

const fetchPricesZamochnikiRequest = createAction(
  "prices/fetchPricesZamochnikiRequest"
);
const fetchPricesZamochnikiSuccess = createAction(
  "prices/fetchPricesZamochnikiSuccess"
);
const fetchPricesZamochnikiError = createAction(
  "prices/fetchPricesZamochnikiError"
);
const hideErrorZamochniki = createAction("prices/hideErrorZamochniki");

const fetchPricesUkrLockRequest = createAction(
  "prices/fetchPricesUkrLockRequest"
);
const fetchPricesUkrLockSuccess = createAction(
  "prices/fetchPricesUkrLockSuccess"
);
...
const fetchPricesSvitZamkivRequest = createAction(
  "prices/fetchPricesSvitZamkivRequest"
);
const fetchPricesSvitZamkivSuccess = createAction(
  "prices/fetchPricesSvitZamkivSuccess"
);
const fetchPricesSvitZamkivError = createAction(
  "prices/fetchPricesSvitZamkivError"
);
const hideErrorSvitZamkiv = createAction("prices/hideErrorSvitZamkiv");

const fetchPricesKupiZamokRequest = createAction(
  "prices/fetchPricesKupiZamokRequest"
);
const fetchPricesKupiZamokSuccess = createAction(
  "prices/fetchPricesKupiZamokSuccess"
);
const fetchPricesKupiZamokError = createAction(
  "prices/fetchPricesKupiZamokError"
);
