...
const errorHouseLock = createReducer(
...
const errorKremin = createReducer(
  { error: null, isOpen: false },
  {
...
const errorZamokUkr = createReducer(
  { error: null, isOpen: false },
  {
...
const errorTopZamok = createReducer(
  { error: null, isOpen: false },
  {
...
const errorSvitZamkiv = createReducer(
  { error: null, isOpen: false },
  {
...
const errorUkrLock = createReducer(
  { error: null, isOpen: false },
  {
...
const errorKupiZamok = createReducer(
  { error: null, isOpen: false },
  {
...
const errorZamochniki = createReducer(
  { error: null, isOpen: false },
  {
